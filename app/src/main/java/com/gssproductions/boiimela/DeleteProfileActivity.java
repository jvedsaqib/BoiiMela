...
public class DeleteProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (firebaseUser.equals("")){
            Toast.makeText(DeleteProfileActivity.this, "User not found", Toast.LENGTH_SHORT).show();
                    ...
                    firebaseUser.reauthenticate(credential).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()){
                                ...
                                //enable delete user button,disable reauthenticate
                                buttonDeleteUser.setEnabled(true);
                                buttonAuthenticate.setEnabled(false);
                                textViewAuthenticated.setText("now you can delete your profile");
                                Toast.makeText(DeleteProfileActivity.this, "you can delete your profile", Toast.LENGTH_SHORT).show();

                                buttonDeleteUser.setBackgroundTintList(ContextCompat.getColorStateList(DeleteProfileActivity.this,R.color.green));
